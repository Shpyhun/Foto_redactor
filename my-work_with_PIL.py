...
"""pict1 = Image.open(SOURCE_DIR + '1_api.jpg')
ava = pict1.crop((0, 0, pict1.width, pict1.width)).resize((700, 700)).transpose(Image.FLIP_LEFT_RIGHT)
ava.save(SOURCE_DIR + 'ava.jpg')
ava.show()"""

first = Image.open(SOURCE_DIR + '2_two_scoops.jpg')
back = Image.open(SOURCE_DIR + '3_django.jpg')
r, g, b = first.split()
...
ava = Image.open(SOURCE_DIR + '4_django_two.jpg')
leo = Image.open(SOURCE_DIR + '5_django_uleashed.jpg')
...
fnt = ImageFont.truetype(SOURCE_DIR + 'fa-regular-400.ttf', 10)
